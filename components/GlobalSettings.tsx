...
import { exportData, importData, clearAllData } from '../services/data.service.ts';
...
export const GlobalSettings: React.FC<GlobalSettingsProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            <Modal isOpen={isOpen} onClose={onClose} title="Pengaturan & Data" maxWidth="max-w-md">
                <div className="p-6 space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="border-t border-slate-100 dark:border-slate-700 pt-4">
                            <h4 className="font-bold text-slate-800 dark:text-slate-200 mb-3 text-sm">Tentang Aplikasi</h4>
