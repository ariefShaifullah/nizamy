...
export const resolveAkdariyyah = (
 ...
 // Standard Akdariyyah resolution (1 Full Sister only):
 // Husband 1/2, Mother 1/3, Grandfather 1/6, Full Sister 1/2
 // Total Furudh = 9/6 → 'Aul to base 9
 // After H+M consume 5/9, remaining 4/9 shared GF:FS at 2:1
 // H = 9/27, M = 6/27, GF = 8/27, FS = 4/27  (total = 27/27)
 ...
 results[HeirEnum.Grandfather]!.reason = "Bagian pokok 1/6. Setelah 'Aul, berkongsi sisa dengan Saudari Kandung (2:1) menjadi 8/27.";
