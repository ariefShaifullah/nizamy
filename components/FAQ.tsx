...
const FAQItem: React.FC<{ q: string; a: string }> = ({ q, a }) => {
    return (
        <details className="group p-4 rounded-lg bg-white shadow-sm transition-all duration-300 open:ring-2 open:ring-primary-500 open:shadow-lg">
            <summary className="font-semibold text-lg cursor-pointer text-slate-800 list-none flex justify-between items-center">
                {q}
    ...
    return (
        <section className="mt-16 mb-8" aria-labelledby="faq-title">
            <div className="text-center mb-8">
                <h2 id="faq-title" className="text-3xl font-extrabold text-slate-900">
                    {title}
                </h2>
