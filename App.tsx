        ...
        >
          ...
          <div className="relative z-10">
            <div className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 text-blue-600 group-hover:scale-110 transition-transform">
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M9 7h6m0 3.666A5.002 5.002 0 0112 21a5.002 5.002 0 01-3-9.666M9 7V4a1 1 0 011-1h4a1 1 0 011 1v3m-6 0h6m-6 4h6"
                />
              </svg>
            </div>
            ...
            <p className="text-slate-500 mb-6 leading-relaxed">
              Hitung pembagian harta warisan (Faraidh) secara mendetail dan
              transparan sesuai Al-Qur'an dan Sunnah.
            </p>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-500 mb-6 leading-relaxed">
              ...
              hingga Pertanian dengan mudah dan akurat.
            </p>
