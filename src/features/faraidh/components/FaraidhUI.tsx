...
export const CustomChartTooltip: React.FC<CustomTooltipProps> = ({ active, payload }) => {
    ...
    return (
      <div className="p-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md shadow-lg text-sm z-tooltip">
        ...
        <p className="text-slate-600 dark:text-slate-300">
            Bagian: {typeof payload[0].value === 'number' ? payload[0].value.toFixed(2) : payload[0].value}%
        </p>
